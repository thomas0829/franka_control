...
python training/basic_bc/train_script.py training.dataset_path="data/synth_sl_100/train" training.image_keys=["front_rgb"] training.state_keys=[] exp_id=bc_synth_sl_100_img

python training/basic_bc/eval_script.py training.dataset_path="data/synth_sl_100/train" training.image_keys=["front_rgb"] training.state_keys=[] exp_id=bc_synth_sl_100_img env.obj_pose_noise_dict=null

python training/basic_bc/train_script.py training.dataset_path="data/synth_sl_100/train" training.image_keys=["front_rgb"] training.state_keys=["lowdim_ee","lowdim_qpos"] exp_id=bc_synth_sl_100_img_proprio

python training/basic_bc/eval_script.py training.dataset_path="data/synth_sl_100/train" training.image_keys=["front_rgb"] training.state_keys=["lowdim_ee","lowdim_qpos"] exp_id=bc_synth_sl_100_img_proprio env.obj_pose_noise_dict=null
