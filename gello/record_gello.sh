...
/home/duanj1/anaconda3/envs/franka/bin/python gello/collect_demos_gello.py \
    ...
    +rec=true \
    +max_duration=60 \
    +instruction="Remove the candy from the cloth." \
    hydra.run.dir=/home/duanj1/thomas/franka_control/gello/outputs/\${now:%Y-%m-%d}/\${now:%H-%M-%S}
