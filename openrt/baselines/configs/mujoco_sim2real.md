...
python openrt/scripts/convert_np_to_hdf5.py --config-name=convert_demos_sim input_datasets=["/media/marius/X9 Pro/pick_red_cube_1k_dr"] output_dataset="pick_red_cube_1k_dr_blocking" splits=["train","eval"]
python openrt/scripts/convert_np_to_hdf5.py --config-name=convert_demos_sim input_datasets=["/media/marius/X9 Pro/pick_language_cube_500"] output_dataset="pick_language_cube_500_blocking" splits=["train","eval"]
