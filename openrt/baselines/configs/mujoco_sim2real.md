...
python openrt/scripts_sim/collect_demos_sim_curobo.py exp_id=pick_red_cube_1k_dr episodes=1000 \
...
python openrt/scripts_sim/collect_demos_sim_multi_cube_curobo.py exp_id="/media/marius/X9 Pro/pick_language_cube_2k" episodes=2000 \
    robot.control_hz=10 robot.max_path_length=100 robot.visual_dr=false \
    env.obj_pose_init="[0.45, 0.0, 0.02, 0., 0., 0., 1.]"

# convert mujoco data (language multi cube)
python openrt/scripts/convert_np_to_hdf5.py --config-name=convert_demos_sim input_datasets=["/media/marius/X9 Pro/pick_language_cube_2k"] output_dataset="pick_language_cube_2k_blocking" splits=["train","eval"]
