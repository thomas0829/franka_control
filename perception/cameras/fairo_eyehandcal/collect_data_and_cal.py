...
import numpy as np
import torch
from cameras.calibration.utils import (build_proj_matrix, detect_corners,
                                       dist_in_hull, find_parameter,
                                       hand_marker_proj_world_camera,
                                       mean_loss, quat2rotvec, rotmat,
                                       world_marker_proj_hand_camera)
# from polymetis import RobotInterface
from realsense_wrapper import RealsenseAPI
from torchcontrol.transform import Rotation as R

from perception.cameras.calibration.utils import uncompress_image
...
def main(argv):
    ...
    if os.path.exists(args.datafile) and not args.overwrite:
        ...
        poses = robot_poses(args.ip, args.robot_model, pose_gen, args.time_to_go)
