...
def load_object(
    ...
    if geom_type == "box":
        ...
        filename = os.path.join("robot/sim/mujoco/assets/franka_assets/meshes", filename)
    ...
    if geom_tex_file is not None and geom_tex_name is not None and geom_type != "mesh":
        ...
        if texture is None:
            geom_tex_file = os.path.join("robot/sim/mujoco/assets/texture", geom_tex_file)
