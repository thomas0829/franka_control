...
from helpers.transformations_r2d2 import add_poses, euler_to_quat, pose_diff, quat_to_euler
from robot.real.inverse_kinematics_r2d2.robot_ik_solver import RobotIKSolver
from robot.controllers.utils import generate_joint_space_min_jerk


class FrankaRobot:

    def __init__(self, ip_address, control_hz=10, custom_controller=True, gain_scale=1.0, reset_gain_scale=1.0):
    ...
    def launch_robot(self, ip_address):
        ...
        self._ik_solver = RobotIKSolver(control_hz=self.control_hz)
